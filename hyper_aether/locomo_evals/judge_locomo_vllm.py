...
You MUST be extremely lenient with your grading: if EVEN ONE core idea, concept, or keyword from the gold answer is present in the generated answer, it MUST be counted as CORRECT. 
